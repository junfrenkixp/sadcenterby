...
function mobileMenu() {
  var mobileBtn = document.querySelector('.header__nav-mob__toggle');
...
window.addEventListener('DOMContentLoaded', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.product__gallery-main').slick({
    dots: false,
    fade: true,
    infinite: true,
    arrows: false,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.product__gallery-nav').slick({
    slidesToShow: 5,
    slidesToScroll: 1,
...
/* harmony import */ var _modules_product_product__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! %modules%/product/product */ "./src/blocks/modules/product/product.js");
